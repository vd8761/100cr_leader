  ...
  return (
    <section className="cta-band section section--pad">
      <div className="section__inner cta-band__inner">
        ...
        <div className="cta-band__row" data-stagger>
          ...
          <Button variant="outline" href="#book" style={{ borderColor: 'var(--sand)', color: 'var(--sand)' }}>Pre-order the Book</Button>
          <Button variant="outline" href={LINKS.whatsapp} target="_blank" rel="noreferrer" style={{ borderColor: 'var(--sand)', color: 'var(--sand)' }}>Join WhatsApp</Button>
        </div>
      </div>
    </section>
  );
